...
MAVLINK_MSG_ID_SEND_PAYLOAD_CMD = 196
MAVLINK_MSG_ID_RECV_PAYLOAD_DATA = 197
...
class MAVLink_send_payload_cmd_message(MAVLink_message):
        '''
        Send a command to the payload.
        '''
        id = MAVLINK_MSG_ID_SEND_PAYLOAD_CMD
        name = 'SEND_PAYLOAD_CMD'
        fieldnames = ['target_system', 'target_component', 'operation', 'cmd']
        ordered_fieldnames = [ 'target_system', 'target_component', 'operation', 'cmd' ]
        format = '<BBB64B'
        native_format = bytearray('<BBBB', 'ascii')
        orders = [0, 1, 2, 3]
        lengths = [1, 1, 1, 64]
        ...
        def __init__(self, target_system, target_component, operation, cmd):
                MAVLink_message.__init__(self, MAVLink_send_payload_cmd_message.id, MAVLink_send_payload_cmd_message.name)
                self._fieldnames = MAVLink_send_payload_cmd_message.fieldnames
                self.target_system = target_system
                self.target_component = target_component
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 121, struct.pack('<BBB64B', self.target_system, self.target_component, self.operation, self.cmd[0], self.cmd[1], self.cmd[2], self.cmd[3], self.cmd[4], self.cmd[5], self.cmd[6], self.cmd[7], self.cmd[8], self.cmd[9], self.cmd[10], self.cmd[11], self.cmd[12], self.cmd[13], self.cmd[14], self.cmd[15], self.cmd[16], self.cmd[17], self.cmd[18], self.cmd[19], self.cmd[20], self.cmd[21], self.cmd[22], self.cmd[23], self.cmd[24], self.cmd[25], self.cmd[26], self.cmd[27], self.cmd[28], self.cmd[29], self.cmd[30], self.cmd[31], self.cmd[32], self.cmd[33], self.cmd[34], self.cmd[35], self.cmd[36], self.cmd[37], self.cmd[38], self.cmd[39], self.cmd[40], self.cmd[41], self.cmd[42], self.cmd[43], self.cmd[44], self.cmd[45], self.cmd[46], self.cmd[47], self.cmd[48], self.cmd[49], self.cmd[50], self.cmd[51], self.cmd[52], self.cmd[53], self.cmd[54], self.cmd[55], self.cmd[56], self.cmd[57], self.cmd[58], self.cmd[59], self.cmd[60], self.cmd[61], self.cmd[62], self.cmd[63]))

class MAVLink_recv_payload_data_message(MAVLink_message):
        '''
        Recieve a command to the payload.
        '''
        id = MAVLINK_MSG_ID_RECV_PAYLOAD_DATA
        name = 'RECV_PAYLOAD_DATA'
        fieldnames = ['target_system', 'target_component', 'cmd']
        ordered_fieldnames = [ 'target_system', 'target_component', 'cmd' ]
        format = '<BB64B'
        native_format = bytearray('<BBB', 'ascii')
        orders = [0, 1, 2]
        lengths = [1, 1, 64]
        ...
        def __init__(self, target_system, target_component, cmd):
                MAVLink_message.__init__(self, MAVLink_recv_payload_data_message.id, MAVLink_recv_payload_data_message.name)
                self._fieldnames = MAVLink_recv_payload_data_message.fieldnames
                self.target_system = target_system
                self.target_component = target_component
                self.cmd = cmd

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 217, struct.pack('<BB64B', self.target_system, self.target_component, self.cmd[0], self.cmd[1], self.cmd[2], self.cmd[3], self.cmd[4], self.cmd[5], self.cmd[6], self.cmd[7], self.cmd[8], self.cmd[9], self.cmd[10], self.cmd[11], self.cmd[12], self.cmd[13], self.cmd[14], self.cmd[15], self.cmd[16], self.cmd[17], self.cmd[18], self.cmd[19], self.cmd[20], self.cmd[21], self.cmd[22], self.cmd[23], self.cmd[24], self.cmd[25], self.cmd[26], self.cmd[27], self.cmd[28], self.cmd[29], self.cmd[30], self.cmd[31], self.cmd[32], self.cmd[33], self.cmd[34], self.cmd[35], self.cmd[36], self.cmd[37], self.cmd[38], self.cmd[39], self.cmd[40], self.cmd[41], self.cmd[42], self.cmd[43], self.cmd[44], self.cmd[45], self.cmd[46], self.cmd[47], self.cmd[48], self.cmd[49], self.cmd[50], self.cmd[51], self.cmd[52], self.cmd[53], self.cmd[54], self.cmd[55], self.cmd[56], self.cmd[57], self.cmd[58], self.cmd[59], self.cmd[60], self.cmd[61], self.cmd[62], self.cmd[63]))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_SEND_PAYLOAD_CMD : MAVLink_send_payload_cmd_message,
        MAVLINK_MSG_ID_RECV_PAYLOAD_DATA : MAVLink_recv_payload_data_message,
...
class MAVLink(object):
        ...
        def send_payload_cmd_encode(self, target_system, target_component, operation, cmd):
                '''
                Send a command to the payload.

                target_system             : System ID (uint8_t)
                target_component          : Component ID (uint8_t)
                operation                 : Operation (uint8_t)
                cmd                       : Command string. Will be sent directly to the payload. (uint8_t)

                '''
                return MAVLink_send_payload_cmd_message(target_system, target_component, operation, cmd)

        def send_payload_cmd_send(self, target_system, target_component, operation, cmd):
                '''
                Send a command to the payload.
                ...
                '''
                return self.send(self.send_payload_cmd_encode(target_system, target_component, operation, cmd))

        def recv_payload_data_encode(self, target_system, target_component, cmd):
                '''
                Recieve a command to the payload.

                target_system             : System ID (uint8_t)
                target_component          : Component ID (uint8_t)
                cmd                       : Command buffer. Will be sent directly to the payload. (uint8_t)

                '''
                return MAVLink_recv_payload_data_message(target_system, target_component, cmd)

        def recv_payload_data_send(self, target_system, target_component, cmd):
                '''
                Recieve a command to the payload.
                ...
                '''
                return self.send(self.recv_payload_data_encode(target_system, target_component, cmd))
