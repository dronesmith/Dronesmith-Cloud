...
var config = require('../config/config'),
	  mailgun = require('mailgun-js')({apiKey: config.mailgun.api, domain: config.mailgun.domain}),

		MAILER_SENDER = 'Dronesmith Team <hello@dronesmith.io>',
...
var mailer = function() {
	...
	function errorHandler(error, body) {
    ...
    sendWelcome: function(user) {
		  ...
		  var apiKey = "Your API key is: <strong>" + user.apiKey + "</strong><br>Remember this! You will need it to access the API.";
			...
			var str = "<h2>Welcome to Dronesmith Cloud!</h2>\n\n"
							...
							+ apiKey
							+ "<br>"
							+ "You can find the API documentation <a href=\"https://readme.dronesmith.io/docs\">here</a>."
							+ "<br><br>"
		...
		resetPassword: function(resetEmail, newPassword) {
			var str = "<h3><em>Hey, listen!</em></h3>\n\n"
							...
							+ "<p>If this was <strong>not</strong> submitted by you, do not use this password, and please <a href=\"mailto:support@dronesmith.io\">contact us</a>.</p>"
							+ "<p>Your new password: <strong>" + newPassword + "</strong></p>";

			mailgun.messages().send({
				from: MAILER_SENDER,
				to: resetEmail.split('@')[0] + '<' + resetEmail + '>',
